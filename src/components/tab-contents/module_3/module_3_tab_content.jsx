...
import { BookOpen, CheckCircle, Play, Target, User } from "lucide-react";
import React from "react";

const Tab3ModuleContent = () => {
  return (
      ...
      <div className="border rounded-lg p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-semibold">
            Module 3: Personality & Behavior Analysis
          </h2>
        </div>
...
export default Tab3ModuleContent;
